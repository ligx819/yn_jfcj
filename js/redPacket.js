        ...
        function snow() {
            ...
            if (settings.delay > 0) {
                ...
                if (settings.image != false) {
                    ...
                    Modal.modal({
                        title: tit,
                        url: cj > 0 ? 'https://ligx819.github.io/yn_jfcj/raffle.html' : 'https://ligx819.github.io/yn_jfcj/index.html',
                        backdrop: false,
                    ...
                    var packs = '<div class="packs">\n' +
                        '  <div class="pack">\n' +
                        '    <img src="https://ligx819.github.io/yn_jfcj/images/fucaifu.png" alt="" width="100%">\n' +
                        '    <span class="pack_count"></span>\n' +
                        '    <p>福彩福</p>\n' +
                        '  </div>\n' +
                        '  <div class="pack">\n' +
                        '    <img src="https://ligx819.github.io/yn_jfcj/images/fulaofu.png" alt="" width="100%">\n' +
                        '    <span class="pack_count"></span>\n' +
                        '    <p>扶老福</p>\n' +
                        '  </div>\n' +
                        '  <div class="pack">\n' +
                        '    <img src="https://ligx819.github.io/yn_jfcj/images/zhucanfu.png" alt="" width="100%">\n' +
                        '    <span class="pack_count"></span>\n' +
                        '    <p>助残福</p>\n' +
                        '  </div>\n' +
                        '  <div class="pack">\n' +
                        '    <img src="https://ligx819.github.io/yn_jfcj/images/jiugufu.png" alt="" width="100%">\n' +
                        '    <span class="pack_count"></span>\n' +
                        '    <p>救孤福</p>\n' +
                        '  </div>\n' +
                        '  <div class="pack">\n' +
                        '    <img src="https://ligx819.github.io/yn_jfcj/images/jikunfu.png" alt="" width="100%">\n' +
                        '    <span class="pack_count"></span>\n' +
                        '    <p>济困福</p>\n' +
                        '  </div>\n' +
                        '</div>';
