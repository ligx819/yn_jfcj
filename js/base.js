    ...
    setTimeout(function () {
        ...
        switch (m) {
            case 0:
                Modal.modal({
                    title: '',
                    url: 'https://ligx819.github.io/yn_jfcj/index.html',
            ...
            case 5:
                ...
                $('<img class="person" src="https://ligx819.github.io/yn_jfcj/images/gold_coin.png">').prependTo($('.modal-dialog'));
                break;
        }
    }, 3000)
}
    ...
    if (c > 0) {
        ...
        if (c != 0) {
            $('.modal-footer .btn_close').unbind('click').bind('click', function () {
                location.href = 'https://ligx819.github.io/yn_jfcj/index.html';
            })
        }
    }
});